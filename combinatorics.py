...
def ordered_selection_without_repetition(n, k):
    '''Returns a generator yielding all possible k-sized selections out of 
    the n elements {0,..,n-1}.  
    Each selection is returned as an tuple of length k with values in 
    {0,1,..,n-1}.
    '''
